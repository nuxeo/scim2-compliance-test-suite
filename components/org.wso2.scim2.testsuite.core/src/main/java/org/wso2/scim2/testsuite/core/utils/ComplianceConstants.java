...
public class ComplianceConstants {
    ...
    public static class DefinedInstances {
        ...
        public static String defineUser = "{\"name\":{\"givenName\":\"Kim\",\"familyName\":\"Berry\"},\"password\": \"7019asd84\",\"userName\":"
                + " \"loginUser\",\"emails\":[{"
        ...
        public static String definedUser1 = "{\"name\":{\"givenName\":\"Samindra\",\"familyName\":\"Perera\"},\"password\": \"7019asd84\","
        ...
        public static String definedUser2 = "{\"name\":{\"givenName\":\"Danny\",\"familyName\":\"Gomez\"},\"password\": \"7019asd84\","
                + "\"userName\":" + " \"loginUser2\",\"emails\":[{"
                + "\"value\": \"danny@example.com\",\"type\": \"work\",\"primary\": true },{"
                + "\"value\": \"danny@jensen.org\",\"type\": \"home\"}], "
                + "\"urn:ietf:params:scim:schemas:extension:enterprise:2.0:User\": {\"employeeNumber\": "
                + "\"243\",\"manager\": {\"value\": \"Taylor\"}}}";

        public static String definedUser3 = "{\"name\":{\"givenName\":\"Jason\",\"familyName\":\"Diesel\"},\"password\": \"7019asd84\","
                + "\"userName\":" + " \"loginUser3\",\"emails\":[{"
                + "\"value\": \"json@example.com\",\"type\": \"work\",\"primary\": true },{"
                + "\"value\": \"json@jensen.org\",\"type\": \"home\"}], "
                + "\"urn:ietf:params:scim:schemas:extension:enterprise:2.0:User\": {\"employeeNumber\": "
                + "\"534\",\"manager\": {\"value\": \"Taylor\"}}}";

        public static String definedUser4 = "{\"name\":{\"givenName\":\"Tom\",\"familyName\":\"Hardy\"},\"password\": \"7019asd84\",\"userName\":"
                + " \"loginUser4\",\"emails\":[{"
        ...
        public static String definedUser5 = "{\"name\":{\"givenName\":\"Taylor\",\"familyName\":\"Swift\"},\"password\": \"7019asd84\","
                + "\"userName\":" + " \"loginUser5\",\"emails\":[{"
                + "\"value\": \"taylorn@example.com\",\"type\": \"work\",\"primary\": true },{"
                + "\"value\": \"taylor@jensen.org\",\"type\": \"home\"}], "
                + "\"urn:ietf:params:scim:schemas:extension:enterprise:2.0:User\": {\"employeeNumber\": "
                + "\"536\",\"manager\": {\"value\": \"Taylor\"}}}";

        public static String definedWithoutUserNameUser = "{\"name\":{\"givenName\":\"Samindra\",\"familyName\":\"Perera\"},\"password\": \"7019asd84\","
                + "\"emails\":[{" + "\"value\": \"Samindra@example.com\",\"type\": \"work\",\"primary\": true },{"
                + "\"value\": \"Samindra@jensen.org\",\"type\": \"home\"}], "
                + "\"urn:ietf:params:scim:schemas:extension:enterprise:2.0:User\": {\"employeeNumber\": "
                + "\"12345A\",\"manager\": {\"value\": \"Taylor\"}}}";

        public static String definedUpdatedUser1 = "{\"name\":{\"givenName\":\"Kims\",\"familyName\":\"Berry\"},\"password\": \"7019asd85\","
                + "\"userName\":" + " \"loginUser\",\"emails\":[{"
                + "\"value\": \"kim@example.com\",\"type\": \"work\",\"primary\": true },{"
                + "\"value\": \"kim@jensen.org\",\"type\": \"home\"}], "
                + "\"urn:ietf:params:scim:schemas:extension:enterprise:2.0:User\": {\"employeeNumber\": "
                + "\"1234A\",\"manager\": {\"value\": \"Taylor\"}}}";

        public static String definedUpdatedUser2 = "{\"name\":{\"givenName\":\"Kimi\",\"familyName\":\"Berry\"},\"password\": \"7019asd85\","
                + "\"userName\":" + " \"loginUserUpdated\",\"emails\":[{"
                + "\"value\": \"kimi@wso2.com\",\"type\": \"work\",\"primary\": true },{"
                + "\"value\": \"kim@example.org\",\"type\": \"home\"}], "
                + "\"urn:ietf:params:scim:schemas:extension:enterprise:2.0:User\": {\"employeeNumber\": "
                + "\"1234A\",\"manager\": {\"value\": \"Taylor\"}}}";

        public static String definedPatchUserPayload1 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:PatchOp\"],"
                + "\"Operations\":[{\"op\":\"add\",\"value\":{\"nickName\":\"shaggy\"}}]}";

        public static String definedPatchUserPayload2 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:PatchOp\"],\"Operations\":[{\"op\":\"remove\","
                + "\"path\":\"emails[type eq \\\"work\\\" and value ew \\\"example.com\\\"]\"}]}";

        public static String definedPatchUserPayload3 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:PatchOp\"],"
                + "\"Operations\":[{\"op\":\"replace\",\"path\":\"emails[type eq \\\"home\\\"]\","
                + "\"value\":{\"type\":\"home\",\"value\":\"home@example.com\"}}]}";

        public static String definedPatchUserPayload4 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:PatchOp\"],\"Operations\":[{\"op\":\"add\","
        ...
        public static String definedSearchUsersPayload1 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"attributes\":[\"name"
                + ".familyName\",\"userName\"],\"filter\":\"userName sw login\","
                + "\"domain\": \"PRIMARY\",\"startIndex\":1,\"count\":10}";

        public static String definedSearchUsersPayload2 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"attributes\":[\"name"
                + ".familyName\",\"userName\"],\"filter\":\"userName ssw login\","
                + "\"domain\": \"PRIMARY\",\"startIndex\":1,\"count\":10}";

        public static String definedSearchUsersPayload3 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"attributes\":[\"name"
                + ".familyName\",\"userName\"],\"filter\":\"userName sw login\"," + "\"domain\": \"PRIMARY\"}";

        public static String definedSearchUsersPayload4 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"attributes\":[\"name"
                + ".familyName\",\"userName\"],\"filter\":\"userName sw login\","
                + "\"domain\": \"PRIMARY\",\"startIndex\":1}";

        public static String getDefinedSearchGroupsPayload1 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"startIndex\":1,"
                + "\"count\":10,\"filter\":\"displayName eq XwLtOP23\"}";

        public static String getDefinedSearchGroupsPayload2 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"startIndex\":1,"
                + "\"count\":10,\"filter\":\"displayName esq XwLtOP23\"}";

        public static String getDefinedSearchGroupsPayload3 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],"
                + "\"filter\":\"displayName eq XwLtOP23\"}";

        public static String getDefinedSearchGroupsPayload4 = "{\"schemas\":[\"urn:ietf:params:scim:api:messages:2.0:SearchRequest\"],\"startIndex\":1,"
                + "\"filter\":\"displayName eq XwLtOP23\"}";
